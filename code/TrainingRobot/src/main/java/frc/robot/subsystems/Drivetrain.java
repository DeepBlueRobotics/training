...
public class Drivetrain extends Subsystem {
 ...
 Joystick leftJoy, rightJoy;
  ...
  public Drivetrain(WPI_TalonSRX talon, WPI_TalonSRX talon2, WPI_VictorSPX VictorSPX, WPI_VictorSPX VictorSPX2, WPI_VictorSPX VictorSPX3, WPI_VictorSPX VictorSPX4) {
    this.talon = talon;
